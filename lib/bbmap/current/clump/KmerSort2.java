...
//				Shared.sort(storage, kc); //Already threaded; this is not needed.
		...
		long diskProcessedT=0;
		long memProcessedT=0;
	}
	...
	long diskProcessed=0;
	long memProcessed=0;

	long readsThisPass=0;
	long memThisPass=0;

	long readsProcessedThisPass=0;
	long clumpsProcessedThisPass=0;
	long correctionsThisPass=0;
	
	long duplicatesThisPass=0;
	static long duplicatesTotal=0;
	
	long clumpsProcessedTotal=0;
	static long correctionsTotal=0;
