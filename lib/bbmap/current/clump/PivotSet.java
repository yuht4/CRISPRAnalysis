...
public class PivotSet {
	...
	public KCountArray process(Timer t, boolean amino){
		...
		KCountArray kca=KmerCount7MTA.makeKca(null, null, null, k, cbits, 0, cells, filterHashes, 0, true, ecco, maxReads, 1, 1, 1, 1, null, 0, amino);
	...
	public static KCountArray makeKcaStatic(final ConcurrentReadInputStream cris, int k, int minCount, boolean amino){
		...
		float fraction=0.1f;
		long cells=getCells(fraction, cbits);
		KCountArray kca=KmerCount7MTA.makeKca(null, null, null, k, cbits, 0, cells, filterHashes, 0, true, false, -1, 1, 1, 1, 1, null, 0, amino);
