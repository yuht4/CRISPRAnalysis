...
//		System.err.println(new String(b));
	...
	private static void speedtest(ByteFile1 tf, long first, long last, boolean reprint){
		...
		if(!reprint){
			...
			System.err.println("Lines Processed:    "+rpstring+" \t"+String.format(Locale.ROOT, "%.2fk lines/sec", rpnano*1000000));
			System.err.println("Bytes Processed:    "+bpstring+" \t"+String.format(Locale.ROOT, "%.2fm bytes/sec", bpnano*1000));
		}
	}
