...
//				if(verbose){outstream.println("Returned a list.");}
		...
		System.err.println("Finished reading input.");
		...
		if(dumped==0){
			...
			storage=null;
			waitOnMemory(outstandingMem, 0);
			System.err.println("Merging "+(dumped+1)+" files.");
			ReadWrite.ZIPLEVEL=ziplevel0;
	...
	private boolean mergeAndDump(ArrayList<String> fnames, IntList dumpCount, boolean useHeader) {
		return mergeAndDump(fnames, dumpCount, ffout1, ffout2, delete, useHeader);
	}
	
	public static boolean mergeAndDump(ArrayList<String> fnames, IntList dumpCount, FileFormat ffout1, FileFormat ffout2, boolean delete, boolean useHeader) {
