...
public class Seal {
	...
	public Seal(String[] args){
		...
		boolean setOutb=false, qtrimRight_=false, qtrimLeft_=false;
		boolean rcomp_=true;
...
//				basesMatched+" bases ("+toPercent(basesMatched*100.0/basesIn)+"%)");
	...
	private void addToRqcMap(){
		BBDukF.putRqc("inputReads", readsIn, false, false);
		BBDukF.putRqc("inputBases", basesIn, false, false);
		if(qtrimLeft || qtrimRight){
			BBDukF.putRqc("qtrimmedReads", readsQTrimmed, false, true);
			BBDukF.putRqc("qtrimmedBases", basesQTrimmed, false, true);
		}
		BBDukF.putRqc("qfilteredReads", readsQFiltered, false, true);
		BBDukF.putRqc("qfilteredBases", basesQFiltered, false, true);
		
		{//This is kind of a hack, to match BBDuk's syntax for RQCFilter.
			BBDukF.putRqc("kfilteredReads", readsMatched, false, true);
			BBDukF.putRqc("kfilteredBases", basesMatched, false, true);

			BBDukF.putRqc("outputReads", readsUnmatched, true, false);
			BBDukF.putRqc("outputBases", basesUnmatched, true, false);
		}
	}
