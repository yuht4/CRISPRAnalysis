...
//				align2.FastaReadInputStream2.verbose=verbose;
	...
	void process(Timer t){
		...
		ArrayList<Read> source=new ArrayList<Read>();
		{
			...
			outstream.println("Reads In:           "+rpstring+" \t"+String.format(Locale.ROOT, "%.2fk reads/sec", rpnano*1000000));
			outstream.println("Bases In:           "+bpstring+" \t"+String.format(Locale.ROOT, "%.2fm bases/sec", bpnano*1000));
		}
		...
		if(readsOut>=0){
			...
			outstream.println("Reads Out:          "+rpstring+" \t"+String.format(Locale.ROOT, "%.2fk reads/sec", rpnano*1000000));
			outstream.println("Bases Out:          "+bpstring+" \t"+String.format(Locale.ROOT, "%.2fm bases/sec", bpnano*1000));
		}
