...
//		if(!Whitelist.contains(value)){return false;}
	...
	public final long[] toSketchArray(){
		int maxLen=SketchObject.toSketchSize(genomeSizeBases, genomeSizeKmers, 
				genomeSizeEstimate(), SketchObject.targetSketchSize);
//		System.err.println(size()+", "+SketchObject.targetSketchSize+", "+genomeSizeBases+", "
//				+genomeSizeKmers+", "+genomeSizeEstimate()+", "+SketchObject.AUTOSIZE+" -> "+maxLen); //123
